...
# Name: Amanda Hoffman (She/Her/Hers)
...
1.  Clearer understanding of R coding

2.  Making publishable quality figures

3.  Level up my understanding of coding
...
graph LR
    A{Is it a <br> top ramen day?} -->|No| B(Is it cold outside?)
    A --> |Yes| C[Eat Ramen]
    B --> C
```
...
```{r}
#| label: fig-fun
#| fig-cap: I like playing with my dog
#| echo: FALSE
#| out-width: 100%
knitr::include_graphics("images/bean.jpg")
```