...
# Name: Nadia Alhassani (she/her/hers)
...
@fig-fun shows me taking a photo, and @fig-fun2 the photo I took:

```{r}
#| label: fig-fun
#| fig-cap: Me taking a photo
#| echo: FALSE
#| out-width: 100%
...
```{r}
#| label: fig-fun2
#| fig-cap: the photo of the secretary bird I took
#| echo: FALSE
#| out-width: 100%
